...
export default function Notifications() {
    ...
    const tabs = [t('all'), t('system_alerts'), t('customer_activity'), t('service_updates')];
        ...
        <div className="flex h-full flex-1 flex-col bg-[#f8fafc] dark:bg-[#0a0a0a] font-sans transition-colors duration-300 overflow-x-hidden">
            ...
            <div className="p-6 md:p-8 max-w-[1600px] w-full mx-auto flex flex-col gap-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">{t('notifications')}</h1>
                        <p className="text-sm text-gray-500 dark:text-slate-400 mt-1">{t('monitor_system_health')}</p>
                    </div>
                ...
                <div className="text-center">
                        <button className="px-6 py-2.5 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 text-sm font-semibold text-gray-700 dark:text-slate-300 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-800 transition-all shadow-sm">
