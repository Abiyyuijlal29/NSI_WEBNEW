...
=======
        <div className="flex h-full flex-1 flex-col bg-[#f8fafc] dark:bg-[#0a0a0a] text-slate-900 dark:text-slate-100 font-sans transition-colors duration-300 overflow-x-hidden">
            ...
            <div className="p-6 md:p-8 max-w-[1600px] w-full mx-auto flex flex-col gap-8">
                ...
                {/* Header Section */}
                <div>
                    <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-1">{t('dashboard_overview')}</h2>
                    <p className="text-sm text-gray-500 dark:text-slate-400">{t('dashboard_summary')}</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-gray-100 dark:border-slate-800 shadow-[0_2px_10px_rgba(0,0,0,0.02)] flex flex-col transition-colors">
                        ...
                        <h3 className="text-xs font-bold text-gray-500 dark:text-slate-500 tracking-wider mb-1 uppercase">{t('active_packages')}</h3>
                    ...
                    <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-gray-100 dark:border-slate-800 shadow-[0_2px_10px_rgba(0,0,0,0.02)] flex flex-col relative overflow-hidden transition-colors">
                        <div className="flex justify-between items-start mb-6">
                            ...
                            <span className="text-[10px] font-bold text-gray-900 dark:text-white bg-gray-100 dark:bg-slate-800 px-2 py-0.5 rounded uppercase tracking-wider border dark:border-slate-700">{t('action_needed')}</span>
                        </div>
                        <h3 className="text-xs font-bold text-gray-500 dark:text-slate-500 tracking-wider mb-1 uppercase">{t('billing_records')}</h3>
                    ...
                    <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-gray-100 dark:border-slate-800 shadow-[0_2px_10px_rgba(0,0,0,0.02)] flex flex-col transition-colors">
                        ...
                        <h3 className="text-xs font-bold text-gray-500 dark:text-slate-500 tracking-wider mb-1 uppercase">{t('est_revenue')}</h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 bg-white dark:bg-slate-900 rounded-xl border border-gray-100 dark:border-slate-800 shadow-[0_2px_10px_rgba(0,0,0,0.02)] p-6 transition-colors">
                        <div className="flex justify-between items-center mb-8">
                            <h3 className="text-sm font-semibold text-gray-800 dark:text-slate-200">{t('customer_growth')}</h3>
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-100 dark:border-slate-800 shadow-[0_2px_10px_rgba(0,0,0,0.02)] flex flex-col transition-colors">
                        <div className="p-6 border-b border-gray-100 dark:border-slate-800 flex justify-between items-center">
                            <h3 className="text-sm font-bold text-gray-900 dark:text-white">{t('recent_activity_log')}</h3>
                        </div>
