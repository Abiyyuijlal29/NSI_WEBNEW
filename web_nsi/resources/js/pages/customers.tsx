...
export default function Customers({ customers }: CustomersProps) {
    ...
    return (
        <div className="flex h-full flex-1 flex-col bg-[#f8fafc] dark:bg-[#0a0a0a] font-sans transition-colors duration-300 overflow-x-hidden">
            <Head title={t('customer_management')} />

            <div className="p-6 md:p-8 max-w-[1600px] w-full mx-auto flex flex-col gap-6">
                {/* Header */}
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">{t('customer_directory')}</h1>
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-gray-100 dark:border-slate-800">
                                    ...
                                    <th className="px-4 py-4 text-left text-xs font-bold text-gray-500 dark:text-slate-500 uppercase tracking-wider">{t('user_details')}</th>
                                    <th className="px-4 py-4 text-left text-xs font-bold text-gray-500 dark:text-slate-500 uppercase tracking-wider">{t('contact')}</th>
                                    ...
                                    <th className="px-4 py-4 text-left text-xs font-bold text-gray-500 dark:text-slate-500 uppercase tracking-wider">{t('last_login')}</th>
