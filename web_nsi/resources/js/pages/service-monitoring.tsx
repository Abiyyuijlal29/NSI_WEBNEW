...
export default function ServiceMonitoring() {
    ...
    return (
        <div className="flex h-full flex-1 flex-col bg-[#f8fafc] dark:bg-[#0a0a0a] font-sans transition-colors duration-300 overflow-x-hidden">
            <Head title={t('service_monitoring')} />

            <div className="p-6 md:p-8 max-w-[1600px] w-full mx-auto flex flex-col gap-6">
                {/* Header */}
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">{t('service_monitoring')}</h1>
                    <p className="text-sm text-gray-500 dark:text-slate-400 mt-1">{t('real_time_infra')}</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-gray-100 dark:border-slate-800 shadow-[0_2px_10px_rgba(0,0,0,0.02)] transition-colors">
                        <div className="flex items-center justify-between mb-4">
                            <span className="text-sm font-medium text-gray-600 dark:text-slate-400">{t('system_health')}</span>
                        ...
                        <div className="flex items-center gap-2 mt-2">
                            ...
                            <span className="text-xs font-semibold text-green-600 dark:text-green-500">{t('operational')}</span>
                        </div>
                    </div>
                    <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-gray-100 dark:border-slate-800 shadow-[0_2px_10px_rgba(0,0,0,0.02)] transition-colors">
                        <div className="flex items-center justify-between mb-4">
                            <span className="text-sm font-medium text-gray-600 dark:text-slate-400">{t('active_servers')}</span>
                        ...
                        <p className="text-xs text-gray-500 dark:text-slate-500 mt-2">{t('all_nodes_responding')}</p>
                    </div>
                    <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-gray-100 dark:border-slate-800 shadow-[0_2px_10px_rgba(0,0,0,0.02)] transition-colors">
                        <div className="flex items-center justify-between mb-4">
                            <span className="text-sm font-medium text-gray-600 dark:text-slate-400">{t('avg_latency')}</span>
                        ...
                        <p className="text-xs text-gray-500 dark:text-slate-500 mt-2">↓ 2ms {t('vs_last_hour')}</p>
                    </div>
                    <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-gray-100 dark:border-slate-800 shadow-[0_2px_10_rgba(0,0,0,0.02)] transition-colors">
                        <div className="flex items-center justify-between mb-4">
                            <span className="text-sm font-medium text-gray-600 dark:text-slate-400">{t('security_alerts')}</span>
                            <ShieldCheck className="w-4 h-4 text-gray-400 dark:text-slate-500" />
                        </div>
                        <p className="text-3xl font-bold text-gray-900 dark:text-white">0</p>
                        <div className="flex items-center gap-2 mt-2">
                            <span className="w-2 h-2 bg-green-500 rounded-full"></span>
                            <span className="text-xs font-semibold text-green-600 dark:text-green-500">{t('clear')}</span>
                        </div>
                    </div>
                </div>
